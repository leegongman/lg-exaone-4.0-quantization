...
def vllm_version_matches_substr(substr: str) -> bool:
    ...
    try:
        ...
        # Allow source-tree execution without requiring an editable install.
        # In that case, fall back to the in-tree version string.
        logger.warning(
            "The vLLM package was not found; falling back to the in-tree "
            "version string for platform detection."
        )
        try:
