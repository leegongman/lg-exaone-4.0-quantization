...
class RotaryEmbedding(RotaryEmbeddingBase):
    ...
    def forward_cpu(
        ...
        # CPU smoke environments can lack the compiled custom op even when the
        # model is otherwise loadable. Fall back to the native reference path
        # so correctness checks can still run.
