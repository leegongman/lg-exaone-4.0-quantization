...
def _build_stable_libtorch_ops() -> bool:
    return os.getenv("VLLM_BUILD_STABLE_LIBTORCH", "1") == "1"


def _build_fa3_ops() -> bool:
    return os.getenv("VLLM_BUILD_FA3", "0") == "1"
...
def get_vllm_version() -> str:
    ...
    if env_version := os.getenv("VLLM_VERSION_OVERRIDE"):
        ...
        return get_version(write_to="vllm/_version.py", relative_to=__file__)
...
if _build_custom_ops():
    ...
    # fixed
    if _is_cuda() and _build_stable_libtorch_ops():
