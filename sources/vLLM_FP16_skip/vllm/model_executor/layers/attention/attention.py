...
from vllm.model_executor.layers.quantization.omni_activation_real import (
    maybe_run_omni_attention,
)
...
class Attention(nn.Module, AttentionLayerBase):
    ...
    def forward(
        ...
        omni_reference_output = maybe_run_omni_attention(
            self,
            query,
            key,
            value,
        ...
        if omni_reference_output is not None:
            return omni_reference_output
