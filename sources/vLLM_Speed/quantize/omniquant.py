...
def omniquant(
    ...
    if args.let and not supports_let:
        raise ValueError(
            "EXAONE 4 uses post-norm decoder layers without input_layernorm/final_layer_norm anchors, "
            "so the current OmniQuant LET formulation is not structurally valid."
        )
